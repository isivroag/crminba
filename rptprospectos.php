...
$consulta = "SELECT * from vtotalprosmes WHERE ejercicio = YEAR(CURDATE()) ";
$resultado = $conexion->prepare($consulta);
$resultado->execute();
$data = $resultado->fetchAll(PDO::FETCH_ASSOC);

$consultaorg = "SELECT * from vtotalprosmesorg WHERE ejercicio = YEAR(CURDATE()) AND mes_id = MONTH(CURDATE())";
...
foreach ($dataorg as $row) {
    ...
    $origenes[$origen][$mes] = $row['nprospectos'];
}
