  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
    <style>
        body {
            ...
            background: radial-gradient(circle, #146e28, #132e0d) !important; /* Degradado radial de verde oscuro a verde más oscuro */
        ...
        .btn-primary {
            background-color: #14320e !important;
            border-color: #14320e   !important;
            font-size: 1.2rem !important;
            padding: 10px !important;
        }
        .btn-primary:hover {
            background-color: #0f290b !important;
            border-color: #0f290b !important;
        }
        .input-group-text {
            background-color: #14320e   !important;
            color: white !important;
