...
$mail->isSMTP();
// ... (configuración SMTP previa)

// Cuerpo del mensaje HTML optimizado para Android y modo oscuro
$mail->Body = '
<!DOCTYPE html>
<html>
<head>
        ...
        <table class="email-container" align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto; background-color: #ffffff; border: 1px solid #cddccf;">
            ...
            <tr>
                <td class="email-content" style="padding: 20px; line-height: 1.5; font-family: Arial, sans-serif; color: #2d2d2d;">
                    <h2 class="email-title" style="color: #153510; text-align: center; margin-bottom: 20px;">Nuevo Prospecto Asignado</h2>
                    
                    <p style="margin: 0 0 15px 0;">Hola ' . htmlspecialchars($data['colaborador']) . ',</p>
                    <p style="margin: 0 0 15px 0;">Se te ha asignado un nuevo prospecto:</p>
                    ...
                    <p style="margin: 15px 0 0 0;">Por favor contacta al prospecto dentro de las próximas 24 horas.</p>
                </td>
            </tr>
            <tr>
...
// Resto del código (vCard y envío) igual que antes
