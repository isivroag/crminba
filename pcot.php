...
<div class="content-wrapper">
                                    ...
                                    <form id="creditForm" class=" p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 form-group form-group-sm">
                                                <label for="nombre_col" class="col-form-label">Vendedor:</label>
                                                <div class="input-group">
                                                    <input type="hidden" id="id_col" name="id_col" class="form-control">
                                                    <input type="text" id="nombre_col" name="nombre_col" class="form-control form-control-sm" placeholder="Buscar Vendedor">
    ...
    <section>
        <div class="container-fluid">
            <!-- Modal de Búsqueda de Vendedores -->
            <div class="modal fade" id="modalVendedor" tabindex="-1" role="dialog" aria-labelledby="modalVendedorLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="table-responsive">
                                <table id="tablaVendedor" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                                    <thead class="text-center bg-gradient-green">
                                        <tr>
                                            <th>ID</th>
                                            <th>NOMBRE</th>
