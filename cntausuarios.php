...
$consulta = "SELECT * FROM w_usuario JOIN rol ON w_usuario.rol_usuario=rol.id WHERE w_usuario.edo_usuario=1 and w_usuario.id_usuario <> '". $_SESSION['s_id_usuario']."' ORDER BY w_usuario.id_usuario";
